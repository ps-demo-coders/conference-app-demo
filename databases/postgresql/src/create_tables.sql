...
(
    ...
    discount_code_id   integer       NOT NULL REFERENCES discount_codes (discount_code_id),
...
(
    session_tag_id integer PRIMARY KEY,
    session_id     integer     NOT NULL REFERENCES sessions (session_id),
    tag            varchar(30) NOT NULL REFERENCES tags (tag)
);
...
(
    ...
    speaker_bio   varchar(4000) NOT NULL,
    speaker_photo varchar(80)   NULL
);

CREATE TABLE speaker_sessions
(
    speaker_session_id integer PRIMARY KEY,
...
CREATE TABLE workshop_presenters
(
    workshop_presenters_id integer PRIMARY KEY,
...
(
    workshop_registration_id integer PRIMARY KEY,
    workshop_id              integer NOT NULL REFERENCES workshops (workshop_id),
